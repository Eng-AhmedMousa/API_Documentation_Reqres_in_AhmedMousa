...
<p align="center">
  <img src="./media/image1.jpeg" alt="API Doc Cover" width="80%">
</p>
</div>
...
<ol dir="rtl">
  ...
  <li>
    <a href="#نظرة-عامة-على-واجهة-reqresin">نظرة عامة على واجهة Reqres.in</a>
    <ul dir="rtl">
      <li><a href="#31-طبيعة-الواجهة-وحدود-الاستخدام">3.1 طبيعة الواجهة وحدود الاستخدام</a></li>
  ...
  <li>
    ...
    <ul dir="rtl">
      <li><a href="#41-الهدف">4.1 الهدف</a></li>
      ...
      <li><a href="#44-استخدام-ال-token">4.4 استخدام الـ Token</a></li>
  ...
  <li>
    ...
    <ul dir="rtl">
      <li><a href="#get--جلب-الموارد">GET – جلب الموارد</a></li>
      <li><a href="#get--جلب-مورد-واحد">GET – جلب مورد واحد</a></li>
    </ul>
  </li>
  <li>
    <a href="#أمثلة-باستخدام-أمر-curl">أمثلة باستخدام أمر curl</a>
    <ul dir="rtl">
      <li><a href="#المصادقة-authentication--login-1">المصادقة (Authentication / Login)</a></li>
      <li><a href="#جلب-مستخدم-ومستخدمين-get">جلب مستخدم ومستخدمين (GET)</a></li>
      <li><a href="#إنشاء-مستخدم-post">إنشاء مستخدم (POST)</a></li>
      <li><a href="#تعديل-كامل-put">تعديل كامل (PUT)</a></li>
      <li><a href="#تعديل-جزئي-patch">تعديل جزئي (PATCH)</a></li>
      <li><a href="#حذف-delete">حذف (DELETE)</a></li>
    </ul>
  </li>
  <li>
    <a href="#معالجة-الأخطاء-error-handling">معالجة الأخطاء (Error Handling)</a>
    <ul dir="rtl">
      <li><a href="#مبادئ-عامة">مبادئ عامة</a></li>
      <li><a href="#رموز-الحالة-الشائعة">رموز الحالة الشائعة</a></li>
      <li><a href="#مسار-تشخيص-سريع-troubleshooting">مسار تشخيص سريع (Troubleshooting)</a></li>
      <li><a href="#أفضل-ممارسات-التعامل-مع-الأخطاء-في-العميل">أفضل ممارسات التعامل مع الأخطاء في العميل</a></li>
    </ul>
  </li>
  <li><a href="#التصفح-pagination">التصفح (Pagination)</a></li>
  <li>
    <a href="#الملاحق">الملاحق</a>
    <ul dir="rtl">
      <li><a href="#مصطلحات-موحدة">مصطلحات موحدة</a></li>
      <li><a href="#روابط-مفيدة">روابط مفيدة</a></li>
    </ul>
  </li>
</ol>
