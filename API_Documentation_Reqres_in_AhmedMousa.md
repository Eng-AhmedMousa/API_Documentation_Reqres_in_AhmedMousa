...
<ol dir="rtl">
  ...
  <li><a href="#المصادقة-authentication--login">المصادقة (Authentication / Login)</a></li>
  ...
  <li><a href="#العمليات-الأساسية-crud-باستخدام-postman">العمليات الأساسية (CRUD) باستخدام Postman</a></li>
  ...
  <li><a href="#العمليات-الأساسية-على-resources">العمليات الأساسية على Resources</a></li>
  ...
  <li><a href="#أمثلة-باستخدام-أمر-curl">أمثلة باستخدام أمر curl</a></li>
  ...
  <li><a href="#معالجة-الأخطاء-error-handling">معالجة الأخطاء (Error Handling)</a></li>
  ...
  <li><a href="#الملاحق">الملاحق</a></li>
